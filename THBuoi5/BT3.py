...
list=['minkowski','cosine','euclidean', 'manhattan','chebyshev']
...
for j in range(1,10,2):
    for i in list:
            ...
            plt.title('K-NN '+ str(i) + ' K= ' + str(j) +' (Test set )')
            plt.xlabel('Age')
            plt.ylabel('Estimated Salary')
            plt.legend()
            plt.show()
